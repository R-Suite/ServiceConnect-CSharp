...
public sealed class SendContext
{
    ...
    /// producer after middleware. The standard middleware contract is to pass the same
    /// <see cref="SendContext"/> through <c>next</c>; transports stamp the wire value from
    /// this property, not from <see cref="Headers"/>.
    /// </summary>
