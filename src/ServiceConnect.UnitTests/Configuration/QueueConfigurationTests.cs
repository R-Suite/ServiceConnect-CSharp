...
public class QueueConfigurationTests
{
    ...
    {
        var config = new QueueConfiguration();
        config.AddQueueMapping(typeof(int), ["queueA", "queueB"]);
    ...
    {
        var config = new QueueConfiguration();
        config.AddQueueMapping(typeof(int), ["queueA"]);
        config.AddQueueMapping(typeof(int), ["queueB", "queueC"]);
    ...
    public void AddQueueMappingListOfQueues_RejectsInvalidElement(string? badQueue)
    {
        ...
        Assert.Throws<ArgumentException>(
            () => config.AddQueueMapping(typeof(int), ["ok", badQueue!]));
    }
