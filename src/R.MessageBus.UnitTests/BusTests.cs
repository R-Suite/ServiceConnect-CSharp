...
namespace R.MessageBus.UnitTests
{
    public class BusTests
    {
        ...
        public void SendingRequestSynchronouslyShouldSendCommand()
        {
            ...
            mockProducer.Setup(x => x.Send(message, It.IsAny<Dictionary<string, object>>())).Callback(task.Start);
            ...
            // Assert
            mockProducer.Verify(x => x.Send(message, It.IsAny<Dictionary<string, object>>()), Times.Once);
        }
        ...
        public void SendingRequestSynchronouslyShouldReturnResponse()
        {
            ...
            mockProducer.Setup(x => x.Send(message, It.IsAny<Dictionary<string, object>>())).Callback(() =>
            {
        ...
        public void SendingRequestWithEndpointSynchronouslyShouldSendMessageToTheSpecifiedEndPoint()
        {
            ...
            mockProducer.Setup(x => x.Send("test", message, It.IsAny<Dictionary<string, object>>())).Callback(task.Start);
            ...
            // Assert
            mockProducer.Verify(x => x.Send("test", message, It.IsAny<Dictionary<string, object>>()), Times.Once);
        }
        ...
        public void SendingRequestWithEndpointSynchronouslyShouldReturnResponse()
        {
            ...
            mockProducer.Setup(x => x.Send("test", message, It.IsAny<Dictionary<string, object>>())).Callback(() =>
            {
                action(new FakeMessage2(message.CorrelationId)
                {
                    DisplayName = "Tim Watson",
        ...
        public void SendingRequestWithCallbackShouldSendCommand()
        {
            ...
            mockProducer.Setup(x => x.Send(message, It.IsAny<Dictionary<string, object>>()));
        ...
        public void SendingRequestWithEndpointAndCallbackShouldSendMessageToTheSpecifiedEndPoint()
        {
            ...
            mockProducer.Setup(x => x.Send("test", message, It.IsAny<Dictionary<string, object>>()));
