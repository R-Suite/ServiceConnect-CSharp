...
nuget push ServiceConnect.5.0.13.nupkg -Source https://www.nuget.org/api/v2/package
nuget push ServiceConnect.Client.RabbitMQ.5.0.10.nupkg -Source https://www.nuget.org/api/v2/package
...
::nuget push ServiceConnect.Persistance.MongoDbSsl.6.0.2.nupkg -Source https://www.nuget.org/api/v2/package
