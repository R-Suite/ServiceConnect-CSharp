...
nuget push ServiceConnect.5.0.8.nupkg -Source https://www.nuget.org/api/v2/package
nuget push ServiceConnect.Client.RabbitMQ.5.0.5.nupkg -Source https://www.nuget.org/api/v2/package
nuget push ServiceConnect.Interfaces.5.0.2.nupkg -Source https://www.nuget.org/api/v2/package
nuget push ServiceConnect.Container.StructureMap.5.0.1.nupkg -Source https://www.nuget.org/api/v2/package
nuget push ServiceConnect.Persistance.MongoDb.5.0.1.nupkg -Source https://www.nuget.org/api/v2/package
nuget push ServiceConnect.Persistance.MongoDbSsl.5.0.1.nupkg -Source https://www.nuget.org/api/v2/package
::nuget push ServiceConnect.Filters.MessageDeduplication.2.0.5.nupkg -Source https://www.nuget.org/api/v2/package
