...
::nuget push ServiceConnect.5.0.10.nupkg -Source https://www.nuget.org/api/v2/package
::nuget push ServiceConnect.Client.RabbitMQ.5.0.6.nupkg -Source https://www.nuget.org/api/v2/package
...
nuget push ServiceConnect.Persistance.MongoDbSsl.5.0.3.nupkg -Source https://www.nuget.org/api/v2/package
