...
::nuget push ServiceConnect.Container.ServiceCollection.1.0.3.nupkg -Source https://www.nuget.org/api/v2/package
::nuget push ServiceConnect.Persistance.MongoDb.5.0.2.nupkg -Source https://www.nuget.org/api/v2/package
nuget push ServiceConnect.Persistance.MongoDbSsl.6.0.1.nupkg -Source https://www.nuget.org/api/v2/package
