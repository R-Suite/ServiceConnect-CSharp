...
nuget push ServiceConnect.Container.StructureMap.4.0.2-pre.nupkg -Source https://www.nuget.org/api/v2/package
nuget push ServiceConnect.Persistance.MongoDb.4.0.2-pre.nupkg -Source https://www.nuget.org/api/v2/package
nuget push ServiceConnect.Persistance.MongoDbSsl.4.0.2-pre.nupkg -Source https://www.nuget.org/api/v2/package
::nuget push ServiceConnect.Filters.MessageDeduplication.2.0.2-pre.nupkg -Source https://www.nuget.org/api/v2/package
