...
::nuget push ServiceConnect.5.0.11.nupkg -Source https://www.nuget.org/api/v2/package
::nuget push ServiceConnect.Client.RabbitMQ.5.0.8.nupkg -Source https://www.nuget.org/api/v2/package
...
nuget push ServiceConnect.Container.ServiceCollection.1.0.0.nupkg -Source https://www.nuget.org/api/v2/package
::nuget push ServiceConnect.Persistance.MongoDb.5.0.2.nupkg -Source https://www.nuget.org/api/v2/package
::nuget push ServiceConnect.Persistance.MongoDbSsl.6.0.1-pre.nupkg -Source https://www.nuget.org/api/v2/package
