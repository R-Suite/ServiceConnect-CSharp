...
nuget push R.MessageBus.1.1.17-beta.nupkg
nuget push R.MessageBus.Interfaces.1.1.17-beta.nupkg
nuget push R.MessageBus.Client.RabbitMQ.1.1.17-beta.nupkg
nuget push R.MessageBus.Persistance.MongoDb.1.1.17-beta.nupkg
