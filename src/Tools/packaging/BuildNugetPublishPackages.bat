...
nuget push R.MessageBus.2.1.6-beta.nupkg
::nuget push R.MessageBus.Interfaces.2.1.2-beta.nupkg
nuget push R.MessageBus.Client.RabbitMQ.2.1.2-beta.nupkg
nuget push R.MessageBus.Container.StructureMap.2.1.7-beta.nupkg
::nuget push R.MessageBus.Persistance.MongoDb.1.1.25-beta.nupkg
::nuget push R.MessageBus.Container.Ninject.2.1.3-beta.nupkg           
