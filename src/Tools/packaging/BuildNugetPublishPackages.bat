...
nuget push ServiceConnect.3.1.3-pre.nupkg -Source https://www.nuget.org/api/v2/package
nuget push ServiceConnect.Client.RabbitMQ.3.1.3-pre.nupkg -Source https://www.nuget.org/api/v2/package
::nuget push ServiceConnect.Interfaces.3.1.0-pre.nupkg -Source https://www.nuget.org/api/v2/package
nuget push ServiceConnect.Container.StructureMap.3.1.1-pre.nupkg -Source https://www.nuget.org/api/v2/package
nuget push ServiceConnect.Persistance.MongoDb.3.1.1-pre.nupkg -Source https://www.nuget.org/api/v2/package
nuget push ServiceConnect.Persistance.MongoDbSsl.3.1.1-pre.nupkg -Source https://www.nuget.org/api/v2/package
nuget push ServiceConnect.Container.Ninject.3.1.1-pre.nupkg -Source https://www.nuget.org/api/v2/package
nuget push ServiceConnect.Filters.MessageDeduplication.1.0.0-pre.nupkg -Source https://www.nuget.org/api/v2/package        
