...
using ServiceConnect.Examples.ScatterGather.CatalogB;
...
var queueName = Environment.GetEnvironmentVariable("SC_EXAMPLES_CATALOG_B_QUEUE_NAME") ?? "scatter-gather-catalog-b";
...
ConsoleStatus.Ready("scatter-gather-catalog-b");
