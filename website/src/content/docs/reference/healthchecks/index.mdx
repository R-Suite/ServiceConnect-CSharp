...
```csharp
// Default — resolves IBus via GetRequiredService<IBus>() from DI
...
```csharp
// Default — resolves IConsumer via GetRequiredService<IConsumer>() from DI
...
```csharp
// Default — resolves IProducer via GetRequiredService<IProducer>() from DI
