---
title: Samples
description: Fourteen runnable console applications covering every messaging pattern and the telemetry stack. Clone, start the docker-compose stack, and watch them work.
---
...
- Source: [`examples/MessageDeduplication`](https://github.com/R-Suite/ServiceConnect-CSharp/tree/master/examples/MessageDeduplication)
