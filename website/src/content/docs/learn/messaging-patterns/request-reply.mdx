...
- [`IBus.SendRequestAsync`](/ServiceConnect-CSharp/reference/bus/ibus/#sendrequestasynctrequest-treply) — single-reply request
- [`IBus.SendRequestMultiAsync`](/ServiceConnect-CSharp/reference/bus/ibus/#sendrequestmultiasynctrequest-treply) — multi-reply request
