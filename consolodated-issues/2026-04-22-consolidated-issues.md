...
- [x] (commit: TBD) **Poison-message unbounded redelivery when retry/error publish throws** — [RabbitMqConsumerHost.cs:354-379](../src/ServiceConnect.Client.RabbitMQ/RabbitMqConsumerHost.cs)
