...
- [x] (commit: TBD) **`MessageBusReadStream.IsComplete` accepts non-contiguous packet sets → silent data corruption** — [MessageBusReadStream.cs:46-65, 115-120](../src/ServiceConnect/Services/MessageBusReadStream.cs)
