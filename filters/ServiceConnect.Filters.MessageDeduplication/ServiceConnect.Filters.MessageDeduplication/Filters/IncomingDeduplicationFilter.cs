...
public class IncomingDeduplicationFilter(IMessageDeduplicationPersistor persistor) : IFilter
{
    private readonly IMessageDeduplicationPersistor _persistor = persistor ?? throw new ArgumentNullException(nameof(persistor));
