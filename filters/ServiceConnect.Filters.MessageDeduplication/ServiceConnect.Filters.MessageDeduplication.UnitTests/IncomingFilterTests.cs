...
namespace ServiceConnect.Filters.MessageDeduplication.UnitTests
{
    public class IncomingFilterTests
    {
        readonly Mock<IMessageDeduplicationPersistor> _persistor = new Mock<IMessageDeduplicationPersistor>();
